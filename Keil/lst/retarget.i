#line 1 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 12 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 13 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 88 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 165 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 329 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
#line 366 "..\\M463_Library\\StdDriver\\src\\retarget.c"
...
void SendChar_ToUART(int ch)
{
    if((char)ch == '\n')
    {
        while(((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->FIFOSTS & (0x1ul << (23))) {}
        ((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->DAT = '\r';
    }

    while(((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->FIFOSTS & (0x1ul << (23))) {}
    ((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->DAT = (uint32_t)ch;
}
...
void SendChar(int ch)
{
#line 524 "..\\M463_Library\\StdDriver\\src\\retarget.c"
    SendChar_ToUART(ch);
...
char GetChar(void)
{
#line 572 "..\\M463_Library\\StdDriver\\src\\retarget.c"

    while(1)
    {
        if((((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
            return ((char)((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->DAT);
        }
    }
...
int kbhit(void)
{
    return !((((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->FIFOSTS & (0x1ul << (14))) == (0x1ul << (14)));
}
...
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) (((uint32_t)0x40000000) + 0x70000UL))->FIFOSTS & (0x1ul << (28))) != 0U);
}
...
#line 692 "..\\M463_Library\\StdDriver\\src\\retarget.c"
