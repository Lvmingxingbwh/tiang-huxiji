...
int32_t SRAM_CompareFunction(uint32_t u32Param0, uint32_t u32Param1, uint32_t u32Param2, uint32_t u32Param3)
{
    ...
    if(u32Param0 == 4)
    {
        ...
        while(u32Idx < u32EBIsize)
        {
            if(u32WriteMode == 0)
            {
                ...
                if((*((volatile unsigned char *)(0x60000000UL +(u32Idx)))) != (uint8_t)(u32CmpData))
                {
                    printf("\nSRAM compare fail, Addr= 0x%x\n", (uint32_t)0x60000000UL + u32Idx);
                    printf("SRAM want data= 0x%x\n", (uint8_t)(u32CmpData));
                    printf("SRAM read data= 0x%x\n", (*((volatile unsigned char *)(0x60000000UL +(u32Idx)))));
            ...
            else if(u32WriteMode == 1)
            {
                u8D0 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx))));
                u8D1 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx + 1))));
            ...
            else if(u32WriteMode == 2)
            {
                u8D0 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx))));
                u8D1 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx + 1))));
                u8D2 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx + 2))));
                u8D3 = (*((volatile unsigned char *)(0x60000000UL +(u32Idx + 3))));
        ...
        while(u32Idx < u32EBIsize)
        {
            if(u32WriteMode == 0)
            {
                ...
                u32CmpData = (uint16_t)(u8D0 + (u8D1 << 8));
                if((*((volatile unsigned short *)(0x60000000UL +(u32Idx)))) != (uint16_t)(u32CmpData))
                {
                    printf("\nSRAM compare fail, Addr= 0x%x\n", (uint32_t)0x60000000UL + u32Idx);
                    printf("SRAM want data= 0x%X\n", (uint16_t)(u32CmpData));
                    printf("SRAM read data= 0x%X\n", (*((volatile unsigned short *)(0x60000000UL +(u32Idx)))));
            ...
            {
                u16D0 = (*((volatile unsigned short *)(0x60000000UL +(u32Idx))));
                u16D1 = (*((volatile unsigned short *)(0x60000000UL +(u32Idx + 2))));
        ...
        while(u32Idx < u32EBIsize)
        {
            if(u32WriteMode == 0)
            {
                ...
                u32CmpData = (uint32_t)(u8D0 + (u8D1 << 8) + (u8D2 << 16) + (u8D3 << 24));
                if((*((volatile unsigned int *)(0x60000000UL +(u32Idx)))) != (uint32_t)(u32CmpData))
                {
                    printf("\nSRAM compare fail, Addr= 0x%x\n", (uint32_t)0x60000000UL + u32Idx);
                    printf("SRAM want data= 0x%X\n", (uint32_t)(u32CmpData));
                    printf("SRAM read data= 0x%X\n", (*((volatile unsigned int *)(0x60000000UL +(u32Idx)))));
    ...
    else
    {
        ...
        while(u32Idx < u32EBIsize)
        {
            if((*((volatile unsigned char *)(0x60000000UL +(u32Idx)))) != (uint8_t)(u32ReadData))
            {
                printf("\nSRAM compare fail, Addr= 0x%X\n", (uint32_t)0x60000000UL + u32Idx);
                printf("SRAM want data= 0x%X\n", (uint8_t)(u32ReadData));
                printf("SRAM read data= 0x%X\n", (*((volatile unsigned char *)(0x60000000UL +(u32Idx)))));
        ...
        while(u32Idx < u32EBIsize)
        {
            if((*((volatile unsigned short *)(0x60000000UL +(u32Idx)))) != (uint16_t)(u32ReadData))
            {
                printf("\nSRAM compare fail, Addr= 0x%X\n", (uint32_t)0x60000000UL + u32Idx);
        ...
        while(u32Idx < u32EBIsize)
        {
            if((*((volatile unsigned int *)(0x60000000UL +(u32Idx)))) != (uint32_t)(u32ReadData))
            {
                printf("\nSRAM compare fail, Addr= 0x%X\n", (uint32_t)0x60000000UL + u32Idx);
...
int32_t SRAM_BS616LV4017(uint32_t u32MaxSize)
{
    ...
    while(u32DataIdx < 5)
    {
        if(u32DataIdx < 4)
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned char *)(0x60000000UL +(u32Idx))) = ((uint8_t)(u32WriteData)));
                u32Idx++;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, 0, 0);
        ...
        else
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned char *)(0x60000000UL +(u32Idx))) = ((uint8_t)(u32WriteData + (uint32_t)&u32Idx)));
                u32Idx++;
                u32WriteData++;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, (uint32_t)&u32Idx, 0);
            if(i32Result) return -1;
            else printf("PASS\n\n");
        }
        u32DataIdx++;
    ...
    while(u32DataIdx < 5)
    {
        if(u32DataIdx < 4)
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned short *)(0x60000000UL +(u32Idx))) = ((uint16_t)(u32WriteData)));
                u32Idx += 2;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, 0, 1);
            if(i32Result) return -1;
            else printf("PASS\n");
        }
        else
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned short *)(0x60000000UL +(u32Idx))) = ((uint16_t)(u32WriteData + (uint32_t)&u32Idx)));
                u32Idx += 2;
                u32WriteData++;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, (uint32_t)&u32Idx, 1);
            if(i32Result) return -1;
            else printf("PASS\n\n");
        }
        u32DataIdx++;
    ...
    while(u32DataIdx < 5)
    {
        if(u32DataIdx < 4)
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned int *)(0x60000000UL +(u32Idx))) = ((uint32_t)(u32WriteData)));
                u32Idx += 4;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, 0, 2);
            if(i32Result) return -1;
            else printf("PASS\n");
        }
        else
        {
            ...
            while(u32Idx < u32EBIsize)
            {
                (*((volatile unsigned int *)(0x60000000UL +(u32Idx))) = ((uint32_t)(u32WriteData + (uint32_t)&u32Idx)));
                u32Idx += 4;
                u32WriteData++;
            }
            ...
            i32Result = SRAM_CompareFunction(u32DataIdx, u32EBIsize, (uint32_t)&u32Idx, 2);
            if(i32Result) return -1;
            else printf("PASS\n\n");
        }
        u32DataIdx++;
