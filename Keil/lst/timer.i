#line 1 "..\\M463_Library\\StdDriver\\src\\timer.c"
...
#line 10 "..\\M463_Library\\StdDriver\\src\\timer.c"
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    if(timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x50000UL)))
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (8))) >> (8);
    }
    else if(timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x50100UL)))
    {
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 & (0x7ul << (12))) >> (12);
    }
    else if(timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x51000UL)))
    {
                             ...
                             uint32_t u32EnableInt)
{
    ...
    t = (timer == ((TIMER_T *) (((uint32_t)0x40000000) + 0x50000UL))) ? ((TIMER_T *) (((uint32_t)0x40000000) + 0x50100UL)) : ((TIMER_T *) (((uint32_t)0x40000000) + 0x51100UL));
...
void TIMER_EnableCaptureInputNoiseFilter(TIMER_T *timer, uint32_t u32FilterCount, uint32_t u32ClkSrcSel)
{
    timer->CAPNF = (((timer)->CAPNF & ~((0x7ul << (8)) | (0x7ul << (4))))
                    | ((0x1ul << (0)) | (u32FilterCount << (8)) | (u32ClkSrcSel << (4))));
}
