#line 1 "..\\M463_Library\\StdDriver\\src\\rtc.c"
...
#line 10 "..\\M463_Library\\StdDriver\\src\\rtc.c"
...
int32_t RTC_Open(S_RTC_TIME_DATA_T *sPt)
{
    ...
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INIT = 0xA5EB1357UL;

    if(((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INIT != (0x1ul << (0)))
    {
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INIT = 0xA5EB1357UL;
        while(((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INIT != (0x1ul << (0)))
        {
    ...
    if(sPt != 0)
    {
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CLKFMT |= (0x1ul << (16));
...
int32_t RTC_32KCalibration(int32_t i32FrequencyX10000)
{
    ...
    if((i32RegInt >= 0) && (i32RegInt <= 31))
    {
        ...
        while((((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->FREQADJ & (0x1ul << (31))) == (0x1ul << (31)))
            if(--u32TimeOutCnt == 0) return (-2L);
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->FREQADJ = (uint32_t)((i32RegInt << 8) | i32RegFra);
        u32TimeOutCnt = SystemCoreClock<<1;  
        while((((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->FREQADJ & (0x1ul << (31))) == (0x1ul << (31)))
            if(--u32TimeOutCnt == 0) return (-2L);
    }
...
void RTC_GetDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    sPt->u32TimeScale = ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CLKFMT & (0x1ul << (0));      
    sPt->u32DayOfWeek = ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->WEEKDAY & (0x7ul << (0));  

     
    g_u32hiYear  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0xful << (20))) >> (20);
    g_u32loYear  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0xful << (16))) >> (16);
    g_u32hiMonth = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0x1ul << (12))) >> (12);
    g_u32loMonth = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0xful << (8))) >> (8);
    g_u32hiDay   = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0x3ul << (4))) >> (4);
    g_u32loDay   = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL & (0xful << (0))) >> (0);

     
    g_u32hiHour = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0x3ul << (20))) >> (20);
    g_u32loHour = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0xful << (16))) >> (16);
    g_u32hiMin  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0x7ul << (12))) >> (12);
    g_u32loMin  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0xful << (8))) >> (8);
    g_u32hiSec  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0x7ul << (4))) >> (4);
    g_u32loSec  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME & (0xful << (0))) >> (0);

     
    u32Tmp  = (g_u32hiYear * 10UL);
    u32Tmp += g_u32loYear;
    sPt->u32Year = u32Tmp + (uint32_t)2000UL;
    ...
    if(sPt->u32TimeScale == (uint32_t)0UL)
    {
        ...
        if(sPt->u32Hour >= 21UL)
        {
            sPt->u32AmPm  = (uint32_t)2UL;
            sPt->u32Hour -= 20UL;
        }
        else
        {
            sPt->u32AmPm = (uint32_t)1UL;
        }
...
void RTC_GetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    g_u32hiYear  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0xful << (20))) >> (20);
    g_u32loYear  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0xful << (16))) >> (16);
    g_u32hiMonth = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0x1ul << (12))) >> (12);
    g_u32loMonth = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0xful << (8))) >> (8);
    g_u32hiDay   = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0x3ul << (4))) >> (4);
    g_u32loDay   = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM & (0xful << (0))) >> (0);

     
    g_u32hiHour = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0x3ul << (20))) >> (20);
    g_u32loHour = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0xful << (16))) >> (16);
    g_u32hiMin  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0x7ul << (12))) >> (12);
    g_u32loMin  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0xful << (8))) >> (8);
    g_u32hiSec  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0x7ul << (4))) >> (4);
    g_u32loSec  = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM & (0xful << (0))) >> (0);
...
void RTC_SetDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    if(sPt != 0)
    {
        ...
        if(sPt->u32TimeScale == (uint32_t)0UL)
        {
            ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CLKFMT &= ~(0x1ul << (0));

             
             
             
            if(sPt->u32AmPm == (uint32_t)2UL)
            {
                sPt->u32Hour += 20UL;
            }
        }
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->WEEKDAY = sPt->u32DayOfWeek;

         
         
         
        u32RegCAL  = ((sPt->u32Year - (uint32_t)2000UL) / 10UL) << 20;
        u32RegCAL |= (((sPt->u32Year - (uint32_t)2000UL) % 10UL) << 16);
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAL  = (uint32_t)u32RegCAL;
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TIME = (uint32_t)u32RegTIME;
    }
}
...
void RTC_SetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    if(sPt != 0)
    {
        ...
        u32RegCALM  = ((sPt->u32Year - (uint32_t)2000UL) / 10UL) << 20;
        u32RegCALM |= (((sPt->u32Year - (uint32_t)2000UL) % 10UL) << 16);
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CALM = (uint32_t)u32RegCALM;
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TALM = (uint32_t)u32RegTALM;
    }
}
...
void RTC_SetDate(uint32_t u32Year, uint32_t u32Month, uint32_t u32Day, uint32_t u32DayOfWeek)
{
    ...
    u32RegCAL  = ((u32Year - (uint32_t)2000UL) / 10UL) << 20;
    u32RegCAL |= (((u32Year - (uint32_t)2000UL) % 10UL) << 16);
    ...
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->WEEKDAY = u32DayOfWeek & (0x7ul << (0));
...
void RTC_SetAlarmDate(uint32_t u32Year, uint32_t u32Month, uint32_t u32Day)
{
    ...
    u32RegCALM  = ((u32Year - (uint32_t)2000UL) / 10UL) << 20;
    u32RegCALM |= (((u32Year - (uint32_t)2000UL) % 10UL) << 16);
...
void RTC_SetAlarmDateMask(uint8_t u8IsTenYMsk, uint8_t u8IsYMsk, uint8_t u8IsTenMMsk, uint8_t u8IsMMsk, uint8_t u8IsTenDMsk, uint8_t u8IsDMsk)
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->CAMSK = ((uint32_t)u8IsTenYMsk << (5)) |
                 ((uint32_t)u8IsYMsk    << (4)) |
...
void RTC_SetAlarmTimeMask(uint8_t u8IsTenHMsk, uint8_t u8IsHMsk, uint8_t u8IsTenMMsk, uint8_t u8IsMMsk, uint8_t u8IsTenSMsk, uint8_t u8IsSMsk)
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TAMSK = ((uint32_t)u8IsTenHMsk << (5)) |
                 ((uint32_t)u8IsHMsk    << (4)) |
                 ((uint32_t)u8IsTenMMsk << (3)) |
                 ((uint32_t)u8IsMMsk    << (2)) |
...
uint32_t RTC_GetDayOfWeek(void)
{
    return (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->WEEKDAY & (0x7ul << (0)));
}
...
void RTC_SetTickPeriod(uint32_t u32TickSelection)
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TICK = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TICK & ~(0x7ul << (0))) | u32TickSelection;
}
...
void RTC_EnableInt(uint32_t u32IntFlagMask)
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INTEN |= u32IntFlagMask;
}
...
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INTEN  &= ~u32IntFlagMask;
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->INTSTS = u32IntFlagMask;
}
...
void RTC_EnableSpareAccess(void)
{
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->SPRCTL |= (0x1ul << (2));
}
...
void RTC_StaticTamperEnable(uint32_t u32TamperSelect, uint32_t u32DetecLevel, uint32_t u32DebounceEn)
{
    ...
    u32Reg = ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TAMPCTL;
    ...
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TAMPCTL = u32Reg;
...
void RTC_DynamicTamperEnable(uint32_t u32PairSel, uint32_t u32DebounceEn, uint32_t u32Pair1Source, uint32_t u32Pair2Source)
{
    ...
    if((u32Pair1Source) && (u32PairSel & (uint32_t)(0x1UL << 1)))
    {
        u32Reg &= ~(0x1ul << (16));
        u32Reg |= u32Tamper2Debounce;
    }

    if((u32Pair2Source) && (u32PairSel & (uint32_t)(0x1UL << 2)))
    {
        u32Reg &= ~(0x1ul << (24));
...
void RTC_DynamicTamperDisable(uint32_t u32PairSel)
{
    ...
    if((u32Reg & (uint32_t)(0x1ul << (0))) && (u32PairSel & (uint32_t)(0x1UL << 1)))
    {
        u32Tamper2En = u32Reg & (0x1ul << (16));
    }

    if((u32Reg & (uint32_t)(0x1ul << (1))) && (u32PairSel & (uint32_t)(0x1UL << 2)))
    {
...
void RTC_DynamicTamperConfig(uint32_t u32ChangeRate, uint32_t u32SeedReload, uint32_t u32RefPattern, uint32_t u32Seed)
{
    ...
    u32Reg &= ~((0x1ul << (3)) | (0x1ul << (4)) | (0x7ul << (5)));

    u32Reg |= (u32ChangeRate) | ((u32SeedReload & 0x1UL) << (4)) |
              (u32RefPattern << (3));

    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TAMPSEED = u32Seed;  
    ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->TAMPCTL = u32Reg;
}
...
uint32_t RTC_SetClockSource(uint32_t u32ClkSrc)
{
    uint32_t u32TrimDefault = (*((volatile unsigned int *)((((uint32_t)0x40000000) + 0x00000UL) + 0x14Cul)));

    if(u32ClkSrc == 0UL)
    {
         
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->LXTCTL &= ~(0x1ul << (7));
...
void RTC_SetGPIOMode(uint32_t u32PFPin, uint32_t u32Mode, uint32_t u32DigitalCtl, uint32_t u32PullCtl, uint32_t u32OutputLevel)
{
    ...
    if((u32PFPin == 4) || (u32PFPin == 5) || (u32PFPin == 6) || (u32PFPin == 7))
    {
        ...
        (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->LXTCTL |= (0x1ul << (8)));

        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL0 = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL0 & ~(0x3FUL << (u32Offset * 8))) |
                        (u32Mode << (u32Offset * 8)) |
    ...
    if((u32PFPin == 8) || (u32PFPin == 9) || (u32PFPin == 10) || (u32PFPin == 11))
    {
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL1 = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL1 & ~(0x3FUL << (u32Offset * 8))) |
                        (u32Mode << (u32Offset * 8)) |
                        (u32OutputLevel << ((u32Offset * 8) + 2)) |
                        (u32DigitalCtl << ((u32Offset * 8) + 3)) |
                        (u32PullCtl << ((u32Offset * 8) + 4));
...
void RTC_SetGPIOLevel(uint32_t u32PFPin, uint32_t u32OutputLevel)
{
    ...
    if((u32PFPin == 4) || (u32PFPin == 5) || (u32PFPin == 6) || (u32PFPin == 7))
    {
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL0 = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL0 & ~(0x4UL << (u32Offset * 8))) |
                        (u32OutputLevel << ((u32Offset * 8) + 2));
    }
    ...
    if((u32PFPin == 8) || (u32PFPin == 9) || (u32PFPin == 10) || (u32PFPin == 11))
    {
        ...
        ((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL1 = (((RTC_T *) (((uint32_t)0x40000000) + 0x41000UL))->GPIOCTL1 & ~(0x4UL << (u32Offset * 8))) |
                        (u32OutputLevel << ((u32Offset * 8) + 2));
    }
}
