#line 1 "..\\M463_Library\\StdDriver\\src\\kpi.c"
...
#line 11 "..\\M463_Library\\StdDriver\\src\\kpi.c"
...
#line 12 "..\\M463_Library\\StdDriver\\src\\kpi.c"
...
__attribute__((weak)) void KPI_KeyHandler(KPI_KEY_T key)
...
void KPI_IRQHandler()
{
    ...
    status = ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->STATUS;
    u32KeyPress[0] = ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KPF[0];
    u32KeyPress[1] = ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KPF[1];
    u32KeyRelease[0] = ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KRF[0];
    u32KeyRelease[1] = ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KRF[1];

    if(status & (0x1ul << (2)))
    {
         
        row = ((((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL & (0x7ul << (28))) >> (28)) + 1;
        col = ((((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL & (0x7ul << (24))) >> (24)) + 1;
            ...
            for(j=0;j<col;j++)
            {
                ...
                if(status & (0x1ul << (3)))
                {
                    if(u32KeyRelease[idx] & mask)
                    {
                        ...
                        ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KRF[idx] = mask;
            ...
            for(j=0;j<col;j++)
            {
                ...
                if(status & (0x1ul << (4)))
                {
                    if(u32KeyPress[idx] & mask)
                    {
                        ...
                        ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->KPF[idx] = mask;
    ...
    if(status & (0x1ul << (1)))
    {
        ...
        ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->STATUS = (0x1ul << (1));
...
int32_t KPI_Open(uint32_t u32Rows, uint32_t u32Columns, KPI_KEY_T *pkeyQueue, uint32_t u32MaxKeyCnt)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST3 |= (0x1ul << (0));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST3 ^= (0x1ul << (0));
    
     
    ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL = ((u32Rows-1) << (28)) | ((u32Columns-1) << (24)) | 
               (0x1ul << (3)) | (0x1ul << (1)) | (0x1ul << (2)) |
               (3 << (16)) |
               (0x1ul << (0));
    
    __NVIC_EnableIRQ(KPI_IRQn);
...
void KPI_Close()
{
    ...
    ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL = 0;
}
...
void KPI_SetSampleTime(uint32_t ms)
{
    uint32_t freq[] = {(12000000UL), (10000UL), (12000000UL), 0};
    
    if(ms >= 1398)
        ms = 1398;
    
    ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->DLYCTL = 0x1F | ((freq[(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (6))) >> (6)] / 1000)*ms << 8);
}
...
void KPI_EnableSlowScan()
{
    ...
    if((((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (6))) == (0x1UL << (6)))
        return;
    
    ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL = (((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->CTL & (~(0xful << (16)))) | (5 << (16));
    ((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->DLYCTL = (((KPI_T *) (((uint32_t)0x40000000) + 0x0C2000UL))->DLYCTL & (~0xff)) | 127;
}
