#line 1 "..\\M463_Library\\StdDriver\\src\\epwm.c"
...
#line 11 "..\\M463_Library\\StdDriver\\src\\epwm.c"
...
uint32_t EPWM_ConfigCaptureChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    if(epwm == ((EPWM_T *) (((uint32_t)0x40000000) + 0x58000UL)))
    {
    ...
    u16Prescale -= 1U;
    ((epwm)->CLKPSC[(u32ChannelNum)] = (u16Prescale));

     
    (epwm)->CTL1 = ((epwm)->CTL1 & ~((0x3ul << (0)) << (u32ChannelNum << 1U))) | (1UL << (u32ChannelNum << 1U));
     
    (epwm)->CTL1 &= ~((0x1ul << (16)) << u32ChannelNum);
...
uint32_t EPWM_ConfigOutputChannel(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    u32Prescale -= 1U;
    ((epwm)->CLKPSC[((u32ChannelNum))] = (u32Prescale));
     
    (epwm)->CTL1 = ((epwm)->CTL1 & ~(((0x3ul << (0)) << (u32ChannelNum << 1U))|((1UL << (16)) << u32ChannelNum)));

    u32CNR -= 1U;
    ((epwm)->PERIOD[(u32ChannelNum)] = (u32CNR));
    ((epwm)->CMPDAT[(u32ChannelNum)]= (u32DutyCycle * (u32CNR + 1U) / 100U));

    (epwm)->WGCTL0 = ((epwm)->WGCTL0 & ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1U))) |                      ((uint32_t)(2U) << ((u32ChannelNum << 1U) + (uint32_t)(0)));

    (epwm)->WGCTL1 = ((epwm)->WGCTL1 & ~(((0x3ul << (16)) | (0x3ul << (0))) << (u32ChannelNum << 1U))) |                      ((uint32_t)(1U) << ((u32ChannelNum << 1U) + (uint32_t)(0)));
...
void EPWM_EnableADCTrigger(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    if(u32ChannelNum < 4U)
    {
        (epwm)->EADCTS0 &= ~(((0x1ful << (0))) << (u32ChannelNum << 3U));
        (epwm)->EADCTS0 |= (((0x1ul << (7)) | u32Condition) << (u32ChannelNum << 3));
    }
    else
    {
        (epwm)->EADCTS1 &= ~(((0x1ful << (0))) << ((u32ChannelNum - 4U) << 3U));
...
int32_t EPWM_EnableADCTriggerPrescale(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Prescale, uint32_t u32PrescaleCnt)
{
    ...
    {
        (epwm)->EADCPSC0 = ((epwm)->EADCPSC0 & ~(((0xful << (0))) << (u32ChannelNum << 3))) |                            (u32Prescale << (u32ChannelNum << 3));

        (epwm)->EADCPSCNT0 = ((epwm)->EADCPSCNT0 & ~(((0xful << (0))) << (u32ChannelNum << 3))) |                              (u32PrescaleCnt << (u32ChannelNum << 3));

    }
    else
    {
        (epwm)->EADCPSC1 = ((epwm)->EADCPSC1 & ~(((0xful << (0))) << ((u32ChannelNum - 4UL) << 3))) |                            (u32Prescale << ((u32ChannelNum - 4UL) << 3));

        (epwm)->EADCPSCNT1 = ((epwm)->EADCPSCNT1 & ~(((0xful << (0))) << ((u32ChannelNum - 4UL) << 3))) |                            (u32PrescaleCnt << ((u32ChannelNum - 4UL) << 3));

    }

    (epwm)->EADCPSCCTL |= (0x1ul << (0)) << u32ChannelNum;
...
void EPWM_EnableDeadZone(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    (epwm)->DTCTL |= ((0x1ul << (0)) << ((u32ChannelNum) >> 1U)) | ((0x1ul << (8)) << ((u32ChannelNum) >> 1U));
...
void EPWM_EnableFaultDetect(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32AfterPrescaler, uint32_t u32ClkSel)
{
    (epwm)->FDEN = ((epwm)->FDEN & ~((0x1ul << (16)) << (u32ChannelNum))) |                    (((0x1ul << (0)) | ((u32AfterPrescaler) << (16))) << (u32ChannelNum));

    (epwm)->FDCTL[(u32ChannelNum)] = ((epwm)->FDCTL[(u32ChannelNum)] & ~(0x3ul << (28))) | (u32ClkSel);
}
...
void EPWM_DisableFaultDetect(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDEN &= ~((0x1ul << (0)) << (u32ChannelNum));
}
...
void EPWM_EnableFaultDetectOutput(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDEN &= ~((0x1ul << (8)) << (u32ChannelNum));
}
...
void EPWM_EnableFaultDetectDeglitch(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32DeglitchSmpCycle)
{
    (epwm)->FDCTL[(u32ChannelNum)] = ((epwm)->FDCTL[(u32ChannelNum)] & (~(0x7ul << (16)))) |                                       ((0x1ul << (31)) | ((u32DeglitchSmpCycle) << (16)));
...
void EPWM_DisableFaultDetectDeglitch(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDCTL[(u32ChannelNum)] &= ~(0x1ul << (31));
}
...
void EPWM_EnableFaultDetectMask(EPWM_T *epwm, uint32_t u32ChannelNum, uint32_t u32MaskCnt)
{
    (epwm)->FDCTL[(u32ChannelNum)] = ((epwm)->FDCTL[(u32ChannelNum)] & (~(0x7ful << (0)))) | ((0x1ul << (15)) | (u32MaskCnt));
}
...
void EPWM_DisableFaultDetectMask(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDCTL[(u32ChannelNum)] &= ~(0x1ul << (15));
}
...
void EPWM_EnableFaultDetectInt(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDIEN |= ((0x1ul << (0)) << (u32ChannelNum));
}
...
void EPWM_ClearFaultDetectInt(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    (epwm)->FDSTS = ((0x1ul << (0)) << (u32ChannelNum));
}
...
uint32_t EPWM_GetFaultDetectInt(EPWM_T *epwm, uint32_t u32ChannelNum)
{
    return (((epwm)->FDSTS & ((0x1ul << (0)) << (u32ChannelNum))) ? 1UL : 0UL);
}
